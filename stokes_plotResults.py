...
deltas=np.asarray([1.5, 1.25, 1, 0.75, 0.5, 0.25, 1e-8])
slopes = (H-h)/(2*deltas)

flux_stokes = np.asarray([2,2,2,2,2,2,2])

dP_H2=np.asarray([-41.42,-42.21,-46.44,-49.61,-53.63,-58.13, -63.8])
...
graphics.plot_2D_inf(res_H2_stokes, slopes, 'Stokes resistance ', ['slope: $\Delta = (H-h)/(2\delta)$','R=dP/Q'])
