...
graphics.plot_2D(eddy_pct_area, H, 'Re=0 BFS: Recirculation %-area', ['Expansion ratio $H/h$','%-area'])
...
# dP_H2_stokes=np.asarray([-47.8, -50.85, -54.54, -58.87,-61.8, -63.98])
# dP_H2_reyn=np.asarray([2.12, 2.15, 2.20, 2.28, 2.34, 2.37])

# dP_H1p5_stokes=np.asarray([-59.89, -61.98, -64.58, -66.64, -68.46])
# dP_H1p5_reyn=np.asarray([2.04, 2.07, 2.11, 2.16, 2.20])


# dP_H1p25_stokes=np.asarray([-73.2, -74.2, -75, -75.6])
# dP_H1p25_reyn=np.asarray([2.03,2.05,2.07,2.08])
