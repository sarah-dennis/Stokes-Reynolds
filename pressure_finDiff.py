...
class Solver_finDiff(P_Solver):
    def __init__(self, height, p0, pN):
        ...
        self.rhs = self.make_rhs(height, p0, pN)
        self.fdMat = self.make_fdMat(height, p0, pN)
    ...
    def make_rhs(self, height, p0, pN):
        N = height.Nx
        c = 6 * height.eta * height.U
    ...
    def make_fdMat(self, height, p0, pN):
        N = height.Nx    
